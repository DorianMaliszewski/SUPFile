            ...
            <div className="container">
                <div className="page-header" id="banner">
                    <div className="row">
                        ...
                        <div class="affichageIntro">
                            <div class="partieAffichageIntro">
                                <h2>Votre cloud de qualité</h2>
                                <img class="tailleImg" src="/nuage.png"/>
                                <p>
                                    Choissisez un cloud de qualité avec SupFile.
                                    Votre cloud vous permet de toujours avoir vos fichier avec vous.
                                </p>
                            </div>
                            <div class="partieAffichageIntro reverse">
                                <h2>Des serveurs puissants et performants</h2>
                                <img class="tailleImg" src="https://upload.wikimedia.org/wikipedia/commons/6/67/Inside_Suite.jpg" />
                                <p>
                                    Choissisez un cloud de qualité avec SupFile.
                                    Votre cloud vous permet de toujours avoir vos fichier avec vous.
                                </p>
                            ...
                            <div class="partieAffichageIntro">
                                <h2>Votre cloud de qualité</h2>
                                <img class="tailleImg" src="https://upload.wikimedia.org/wikipedia/commons/9/9e/Samsung_Galaxy_Note_5%2C_S6_edge%2B_and_Note_7_20161010b.jpg" />
                                <p>
                                    Choissisez un cloud de qualité avec SupFile.
                                    Votre cloud vous permet de toujours avoir vos fichier avec vous.
                                </p>
